...

{
	...
	public static void main(String[] args) {
		...
		String ccs = "prabhudatta.c@tadigital.com";//
		String bccs = "prabhudatta.c@tadigital.com";//
		String userName = "prabhudatta.c@tadigital.com";
		String passWord = "Prabhu143##";
		String host = "mail.live.com";
		String port = "587";
		...
		Map<String, Set<String>> detailsTest2 = sd.getExcelReportFolderDetails();
		...
		String attachmentPath = System.getProperty(USER_DIR);
		String to[] = { tos };
		String cc[] = { ccs, "prabhudatta.c@tadigital.com", "prabhudatta.c@tadigital.com" };// ""
		String bcc[] = { bccs };
	...
	public Map<String, Set<String>> getExcelReportFolderDetails() {
		this.executionDetails = new ConcurrentHashMap<>();

		String sureFireReportPath = System.getProperty(USER_DIR) + "/src/test/resources/testData/NFR/";
		File[] directories = new File(sureFireReportPath).listFiles();
		Set<String> testFiles = new HashSet<String>();

		for (File dir : directories) {
			if (dir.getName().contains(".xlsx")) {
				testFiles.add(dir.getName());
				executionDetails.put("/src/test/resources/testData/NFR/", testFiles);
			}
